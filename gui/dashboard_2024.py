...
class Ui(QtWidgets.QMainWindow):
    ...
    def initialize_widgets(self):
        ...
        'qlabel_arm_retract_indicator': {'widget': self.qlabel_arm_retract_indicator, 'nt': '/SmartDashboard/ArmMoveDown/running', 'command': '/SmartDashboard/ArmMoveDown/running'},
        'qlabel_arm_extend_indicator': {'widget': self.qlabel_arm_extend_indicator, 'nt': '/SmartDashboard/ArmMoveUp/running', 'command': '/SmartDashboard/ArmMoveUp/running'},
