...
class Ui(QtWidgets.QMainWindow):
    ...
    def initialize_widgets(self):
        ...
        'qlabel_apriltag_back_target_indicator': {'widget': self.qlabel_apriltag_back_target_indicator, 'nt': '/SmartDashboard/tag_targets_exist', 'command': None},
        'qlabel_apriltag_front_target_indicator': {'widget': self.qlabel_apriltag_front_target_indicator, 'nt': '/SmartDashboard/tag_targets_exist', 'command': None},
