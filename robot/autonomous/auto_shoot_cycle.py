...
class AutoShootCycle(commands2.SequentialCommandGroup):
    def __init__(self, container, go_to_shoot=True) -> None:
        ...
        self.addCommands(ShooterToggle(container=self.container, shooter=self.container.shooter, force='on', rpm=3200, amp_rpm=3000, # usually rpm=3500, amp_rpm=2000; changed amp_rpm from 1500 to 3000 for LCE presentation 081524
