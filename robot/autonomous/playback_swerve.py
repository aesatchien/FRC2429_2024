...
class PlaybackSwerve(commands2.CommandBase):  # change the name for your command
    ...
    def execute(self) -> None:
        ...
        if current_inputs['driver_controller']['button']['LB'] and not previous_inputs['driver_controller']['button'][
            'LB']:
            slowmode_multiplier = constants.k_slowmode_multiplier
        elif current_inputs['driver_controller']['axis']['axis2'] and not previous_inputs['driver_controller']['axis'][
            'axis2']:
