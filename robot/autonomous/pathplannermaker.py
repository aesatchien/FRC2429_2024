...
class PathPlannerConfiguration():
    ...
    def configure_paths(self, autonomous_chooser:wpilib.SendableChooser):
        allowed_autos = ['1+1 amp', '1+1 middle', '1+1 source', '1+0', "1+0 leave amp", "1+0 leave source", "1+1 amp with midline", "1+1 source with midline", "1+2 middle source", "1+2 middle amp", "1+1 and leave source side AVR"]
