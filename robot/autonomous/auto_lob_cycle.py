...
class AutoLobCycle(commands2.SequentialCommandGroup):
    def __init__(self, container, go_to_shoot=True) -> None:
        ...
        self.addCommands(ShooterToggleLob(container=self.container, shooter=self.container.shooter, force='on', rpm=1500, amp_rpm=1500, # usually rpm=3500, amp_rpm=2000
