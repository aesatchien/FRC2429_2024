...
class RobotContainer:
    ...
    def initialize_dashboard(self):
        ...
        self.position_chooser.setDefaultOption("2, 2, 0", {"x": 2, "y": 2, "rotation": 0}) #Note: (0,0) is the bottom left corner of the field.
        ...
        self.autonomous_chooser.addOption("manual option", PathPlannerConfiguration.on_the_fly_path(self.drive, self.position_chooser.getSelected(), 0).withTimeout(5))
