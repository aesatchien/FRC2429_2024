...
class ShooterCrankArmTrapezoidal(commands2.TrapezoidProfileSubsystem):
    ...
    positions = {'intake': 10, 'shoot': 10, 'amp': 90, 'trap': 180}  # todo: set a rest?
    ...
    def __init__(self) -> None:
        ...
        self.counter = 0
        self.max_angle = 181 * math.pi / 180  # straight up is 90, call max allawable 120 degrees  todo: remeasure and verify
        self.min_angle = 9 * math.pi / 180  # do not close more than this
        ...
        self.abs_encoder.setZeroOffset(pos_factor * 0.188)  # TODO - reverify
