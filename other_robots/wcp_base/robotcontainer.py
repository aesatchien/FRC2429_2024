...
class RobotContainer:
    ...
    def configureButtonBindings(self):
        ...
        self.buttonY.whileTrue(ChargeStationBalance(self, self.drive, velocity=10, tolerance=10))

        # bind commands to co-pilot
        self.co_buttonA.onTrue(BucketMove(self, setpoint=100, bucket=self.bucket, wait_to_finish=True ))
        self.co_buttonB.onTrue(BucketMove(self, setpoint=0, bucket=self.bucket, wait_to_finish=True ))
