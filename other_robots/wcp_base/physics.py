...
class PhysicsEngine:
    ...
    def update_sim(self, now: float, tm_diff: float) -> None:
        ...
        l_motor, r_motor = self.l_spark_output.value, self.r_spark_output.value
        wpilib.SmartDashboard.putNumber('motor_l', l_motor)
        wpilib.SmartDashboard.putNumber('motor_r', r_motor)
